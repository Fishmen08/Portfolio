    ...
    return (
        <div className='pt-project'>
            <div className='head-section'>
                ...
                <a href='https://fitnessbyfish.netlify.app/' target='_blank' rel='noreferrer'>fitnessbyfish.netlify.app</a>
            ...
            <div className='project-frameworks'>
                <p>React - React-Router - Netlify - Tailwind - Firebase - Firestore</p>
            </div>
            ...
            <div>
                <Link id='link-home' to='/'>Back to home</Link>
            </div>
        </div>
    )
}